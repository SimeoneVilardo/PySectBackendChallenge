...
from server.apps.core.models import ChallengeSubmission, Challenge, User
...
class ChallengeSubmissionRunView(UpdateAPIView):
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        zip_file = RunnerService.create_zip_file(challenge_submission)
        ...
        challenge_output = self.get_challenge_output(challenge)
    ...
    def get_challenge_output(cls, challenge: Challenge):
        challenge_output_path = os.path.join(settings.BASE_OUTPUT_PATH, challenge.output_path)
