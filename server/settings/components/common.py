...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"submissions_run": "15/hour"},
...
AWS_CHALLENGE_SUBMISSION_RESULT_TOPIC_ARN = config(
    "AWS_CHALLENGE_SUBMISSION_RESULT_TOPIC_ARN"
)
AWS_CHALLENGE_SUBMISSION_RUN_STEP_FUNCTION_ARN = config(
    "AWS_CHALLENGE_SUBMISSION_RUN_STEP_FUNCTION_ARN"
)
